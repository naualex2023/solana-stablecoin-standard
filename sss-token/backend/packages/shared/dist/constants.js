...
exports.ERROR_CODES = exports.HTTP_STATUS = exports.DEFAULTS = exports.WEBHOOK_STATUS = exports.BLACKLIST_SOURCES = exports.REQUEST_STATUS = exports.EVENT_TYPES = exports.REDIS_KEYS = exports.REDIS_CHANNELS = exports.SSS_TOKEN_PROGRAM_ID = void 0;
// SSS Token Program ID (default)
exports.SSS_TOKEN_PROGRAM_ID = process.env.SSS_PROGRAM_ID || 'Hf1s4EvjS79S6kcHdKhaZHVQsnsjqMbJgBEFZfaGDPmw';
// Redis channel names
...
// Blacklist sources
exports.BLACKLIST_SOURCES = {
    MANUAL: 'manual',
    OFAC: 'ofac',
    SYSTEM: 'system',
};
// Webhook delivery statuses
exports.WEBHOOK_STATUS = {
    PENDING: 'pending',
    SENT: 'sent',
    FAILED: 'failed',
    RETRYING: 'retrying',
